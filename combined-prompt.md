...
Use LTP file uploaded to retrieve the LTP source CSV.
...
Use the uploaded IK07 file to retrieve the IK07 source CSV.
...
Return the generated NEO, LAO and exception CSV files and only one valid JSON object. Do not wrap it in Markdown. Do not add explanatory text before or after it.
